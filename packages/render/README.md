...
```sh
yarn add @easypliant/react-pdf-render
```

## How it works

```js
import render from '@easypliant/react-pdf-render';
import primitives from '@easypliant/react-pdf-primitives';
...
Mandatory field specifiying the type of the particular node. The full list of types can be found and imported from `@easypliant/react-pdf-primitives`
...
import fs from 'fs';
import render from '@easypliant/react-pdf-render';
import pdfkit from '@easypliant/react-pdf-pdfkit';
