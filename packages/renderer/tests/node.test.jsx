...
describe("node", () => {
  ...
  test("should render a child array", async () => {
    ...
    const children = [
      <View key="child1" style={{ width: 20, height: 20, backgroundColor: "red" }} />,
      <View key="child2" style={{ width: 20, height: 20, backgroundColor: "red" }} />,
    ];
  ...
  test("should render nested dynamic views", async () => {
    const renderNode = <View key="child1" style={{ width: 20, height: 20, backgroundColor: "red" }} />;
