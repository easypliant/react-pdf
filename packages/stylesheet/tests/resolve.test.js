...
describe("stylesheet resolve", () => {
  ...
  test("should return several style objects flatten", () => {
    const style = [{ backgroundColor: "black" }, { color: "red", textAlign: "center" }];
    const result = resolve({}, style);
  ...
  test("should keep hex colors as they are", () => {
    const styles = resolve({}, { color: "#0000FF", backgroundColor: "#FF0000" });
  ...
  test("should transform rgb colors to hexa", () => {
    const styles = resolve({}, { color: "rgb(255, 0, 0)", backgroundColor: "rgb(0, 0, 255)" });
  ...
  test("should transform hsl colors to hexa", () => {
    const styles = resolve({}, { color: "hsl(0, 100%, 50%)", backgroundColor: "hsl(204, 100%, 50%)" });
  ...
  test("should transform margin shortcut units with decimals correctly", () => {
    const styles = resolve({}, { margin: "10.5cm 20.005in 30.10mm 40.0000005pt" });
  ...
  test("should transform padding shortcut units with decimals correctly", () => {
    const styles = resolve({}, { padding: "10.5cm 20.005in 30.10mm 40.0000005pt" });
